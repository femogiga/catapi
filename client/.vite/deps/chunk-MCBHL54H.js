...
var Portal = React29.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React29.isValidElement(children2) ? children2.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var SvgIcon = React74.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React74.isValidElement(children2) && children2.type === "svg";
  const ownerState = _extends({}, props, {
    color,
    component,
    fontSize,
...
var timeoutsShape = true ? import_prop_types33.default.oneOfType([import_prop_types33.default.number, import_prop_types33.default.shape({
  enter: import_prop_types33.default.number,
  exit: import_prop_types33.default.number,
  appear: import_prop_types33.default.number
}).isRequired]) : null;
var classNamesShape = true ? import_prop_types33.default.oneOfType([import_prop_types33.default.string, import_prop_types33.default.shape({
  enter: import_prop_types33.default.string,
  exit: import_prop_types33.default.string,
  active: import_prop_types33.default.string
}), import_prop_types33.default.shape({
  enter: import_prop_types33.default.string,
  enterDone: import_prop_types33.default.string,
  enterActive: import_prop_types33.default.string,
  exit: import_prop_types33.default.string,
  exitDone: import_prop_types33.default.string,
  exitActive: import_prop_types33.default.string
})]) : null;
...
Transition.propTypes = true ? {
   ...
   */
  nodeRef: import_prop_types34.default.shape({
    current: typeof Element === "undefined" ? import_prop_types34.default.any : function(propValue, key, componentName, location, propFullName, secret) {
      var value = propValue[key];
      return import_prop_types34.default.instanceOf(value && "ownerDocument" in value ? value.ownerDocument.defaultView.Element : Element)(propValue, key, componentName, location, propFullName, secret);
    }
  }),
  /**
   ...
   * ```
   */
  children: import_prop_types34.default.oneOfType([import_prop_types34.default.func.isRequired, import_prop_types34.default.element.isRequired]).isRequired,
  /**
   ...
   */
  mountOnEnter: import_prop_types34.default.bool,
  /**
   * By default the child component stays mounted after it reaches the `'exited'` state.
   * Set `unmountOnExit` if you'd prefer to unmount the component after it finishes exiting.
   */
  unmountOnExit: import_prop_types34.default.bool,
  /**
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MCBHL54H.js.map
